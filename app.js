...
//var authRouter = require("./routes/authRouter"); // Login Node
var auth = require("./routes/auth"); // Login React
...
app.use("/auth", auth); // Login React
//app.use("/auth", authRouter); // Login Node
